<?php
/** 
 * Property List Parser Class
 * Unserialises data stored in .plist Property List files.
 *
 * Created by Jeremy Johnstone (@jsjohnst, http://www.jeremyjohnstone.com)
 * Github project: https://github.com/jsjohnst/php_class_lib/
 * Modified for use in b2bFront by Damien Walsh
 *
 * NB: http://en.wikipedia.org/wiki/Property_List
 * 
 * @author Damien Walsh <damien@transcendsolutions.net>
 * @package b2bfront
 * @version [Commit:0371782]
 */
class PropertyList extends XMLReader
{
  /**
   * Parse a file at the given location
  ...
  /**
   * Parse the PList data and produce an array.
   * @return array
   */
  ...
  /**
   * Parse the current node and return the resulting value.
   * @return mixed
   */
  ...
  /**
   * Get the inner XML text of the current node.
   * @return string
   */
  ...
  /**
   * Get the next node that is one of the specified types.
   * NB: This method may be called with multiple undefined arguments.
   * @return boolean
   */
  ...
  /**
   * Verify if the current node matches a specified type and name.
   * @param string $type The type of the node to examine.
   * @param string $name The name of the node to examine.
   * @return boolean
   */
