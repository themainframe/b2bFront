...
<div class="panel">
  ...
  <div class="contents">
      <span class="button" style="float:left;">
        <a href="./?act=orders&mode=unprocessed_process&id=<?php print $orderID; ?>">
          <span class="img" 
          style="background-image:url(/acp/static/icon/tick-circle.png)">
          &nbsp;</span>Mark as Processed
        </a>
      </span>
...
?>
      ...
      <span class="button" style="float:left;">
        <a href="./?act=orders&mode=unprocessed_hold&id=<?php print $orderID; ?>">
          <span class="img" 
          style="background-image:url(/acp/static/icon/exclamation-octagon.png)">
          &nbsp;</span>Mark as Held
        </a>
      </span>
...
?>
      ...
      <span class="button" style="float:right;">
        <a href="./?act=orders&mode=unprocessed">
          <span class="img" 
  ...
  <div class="contents">
    ...
    <table style="width: 100%;" class="info">
      ...
      <tr>
        ...
        <td class="key">Dealer Landline #</td>
        <td><?php print $dealerRow->phone_landline; ?></td>
      </tr>
      <tr>
