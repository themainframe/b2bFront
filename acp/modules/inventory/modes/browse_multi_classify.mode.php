...
<h1>Multiple Item Classification</h1>
<br />
...
<div class="panel">
  ...
  <div class="contents">
    ...
    <h3>Any attributes associated with these items will be lost when they are reclassified.</h3>
    
    <p>
      If you wish to continue, select a new classification from the box below and then click Save and Exit.
    </p>
...
<form method="post" action="./?act=inventory&mode=browse_multi_classify_do">
      ...
      <tbody>
        ...
        <tr class="last">
          <td class="key">
            ...
            The new classification of the selected items.
          </td>
          <td class="value">
<?php
